...
public interface IAssignmentService
{
    ...
    Task<ResponseViewModel<CountedResponse<List<AssignmentBaseModal>>>> GetGroupAssignments(int userId, int groupId,
        int? offset, int? limit);

    Task<ResponseViewModel<CountedResponse<List<UserAssignmentBaseModal>>>> GetUserAssignments(int userId, int statusId,
        int? offset, int? limit);
    ...
    Task<ResponseViewModel<CountedResponse<List<UserAssignmentBaseModal>>>> GetUserNotSeenEvaluatedAssignments(
    ...
    Task<ResponseViewModel<CountedResponse<List<UserAssignmentBaseModal>>>> GetTeacherAssignments(int userId,
        int? offset, int? limit);

    Task<ResponseViewModel<AssignmentBaseModal>> GetAssignmentBaseInfoById(int assignmentId);

    Task<ResponseViewModel<CountedResponse<List<UserAssignmentBaseModal>>>> GetAssigmentUsersTasks(int assignmentId,
